...
const VendorRegister = () => {
  ...
  const { mutate, isLoading } = useMutation((data) => request({ url: `/auth/signup-admin`, data, method: 'post' }), {
    onSuccess: (resData) => {
      SuccessHandle(resData, router, `/${i18Lang}/auth/login`, t('RegistrationSuccessfully'));
    },
  });
