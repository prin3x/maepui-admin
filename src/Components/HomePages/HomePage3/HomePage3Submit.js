...
const HomePage3Submit = (values) => {
    ...
    if (values['homeBannerSubBannerImage']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerSubBannerImage'].url
    ...
    if (values['offerBannerImage']) {
        values['content']['offer_banner']['image_url'] = values['offerBannerImage'].url
    ...
    values['content']['product_bundles']['bundles'].forEach((elem, i) => {
        if (values[`productBundleImage${i}`]) {
            values['content']['product_bundles']['bundles'][i]['image_url'] = values[`productBundleImage${i}`].url
