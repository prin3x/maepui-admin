...
const POS = () => {
  ...
  const { data: CategoryData, isLoading } = useQuery([Category], () => request({ url: Category, params: { type: 'product', status: 1 } }), { refetchOnWindowFocus: false, select: (data) => data.data });
