...
export function ProductInitValues(oldData, updateId) {
  ...
  return {
    ...
    stock_status: updateId ? oldData?.quantity > 0 || "in_stock" : "",
    show_stock_quantity: true,
    sku: updateId ? oldData?.sku || "" : "",
    stock_quantity: updateId ? oldData?.stock_quantity || "" : "",
    ...
    thumbnail_id: updateId ? oldData?.thumbnail?.id || "" : "",
    size_chart_image: updateId ? oldData?.size_chart_image || "" : "",
    size_chart_image_id: updateId ? oldData?.size_chart_image?.id || "" : "",
    galleries: updateId ? oldData?.galleries || "" : "",
    galleries_id: updateId ? oldData?.galleries?.map((elem) => elem.id) || "" : "",
    // SEO
    ...
    shipping_price: updateId ? oldData?.shipping_price : "",
