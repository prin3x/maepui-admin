...
const HomePage6Submit = (values) => {
    ...
    if (values['homeBannerImage1']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeBannerImage1'].url
    } else values['content']['home_banner']['main_banner']['image_url'] = ''

    if (values['homeBannerImage2']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeBannerImage2'].url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['mainContentLeftCategoryImage']) {
        values['content']['main_content']['section2_categories_icon_list']['image_url'] = values['mainContentLeftCategoryImage'].url

    } else values['content']['main_content']['section2_categories_icon_list']['image_url'] = ''

    if (values['mainContentLeftBannerImage']) {
        values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = values['mainContentLeftBannerImage'].url

    } else values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = ''

    if (values['mainContentLeftBannerImage2']) {
        values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = values['mainContentLeftBannerImage2'].url
