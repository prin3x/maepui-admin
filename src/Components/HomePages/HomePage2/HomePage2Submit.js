...
const HomePage2Submit = (values) => {
    ...
    if (values['homeMainBannerImage']) {
        values['content']['home_banner']['main_banner']['image_url'] = values['homeMainBannerImage'].url
    } else values['content']['home_banner']['main_banner']['image_url'] = ""

    if (values['homeMainSubBanner1Image']) {
        values['content']['home_banner']['sub_banner_1']['image_url'] = values['homeMainSubBanner1Image'].url
    } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

    if (values['homeMainSubBanner2Image']) {
        values['content']['home_banner']['sub_banner_2']['image_url'] = values['homeMainSubBanner2Image'].url
    } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

    if (values['categoriesIconImage']) {
        values['content']['categories_icon_list']['image_url'] = values['categoriesIconImage'].url
    } else values['content']['categories_icon_list']['image_url'] = ''

    if (values['couponImage']) {
        values['content']['coupons']['image_url'] = values['couponImage'].url
    } else values['content']['coupons']['image_url'] = ''

    if (values['mainContentRightBanner1Image']) {
        values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] = values['mainContentRightBanner1Image'].url
    } else values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] = ''

    if (values['mainContentRightBanner2Image']) {
        values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['image_url'] = values['mainContentRightBanner2Image'].url
