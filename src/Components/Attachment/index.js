        ...
        <Container fluid={true}>
            <Row>
                <Col sm="12">
                    <Card>
                        <CardBody>
                            <AttachmentHead isattachment={isattachment} state={state} dispatch={dispatch} refetch={refetch} attachmentsData={attachmentsData || []} />
                            ...
                            <div className="content-section select-file-loader select-file-section py-0 ratio2_3">
                                ...
                                <Row xxl={6} xl={5} md={4} sm={3} xs={2} className="g-sm-3 g-2 media-library-sec ratio_square">
                                    <MediaData state={state} dispatch={dispatch} search={search} sorting={sorting} attachmentsData={attachmentsData || []} refetch={refetch} />
                                </Row>
                            </div>
                        </CardBody>
                        {attachmentsData?.length > 0 && <TableBottom
