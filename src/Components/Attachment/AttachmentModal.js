...
import useUplaodImages from '@/Utils/Hooks/CustomHooks/useUploadImages';
...
const AttachmentModal = (props) => {
  ...
  const { images, uploading, error, uploadImages } = useUplaodImages();
              ...
              <div>
                ...
                <Formik
                  ...
                  onSubmit={async (values, { resetForm }) => {
                    ...
                    try {
                      await uploadImages(formData, bucket, uploadType);
